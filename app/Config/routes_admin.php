...
$language = array('language' => 'en|pt'); //ACCEPTED LANGUAGES
Router::connect('/admin/:language', array('controller' => 'pages', 'action' => 'display', 'admin_home', 'admin' => true), $language); //HOMEPAGE
Router::connect('/admin/:language/:controller/:action/*', array('admin' => true), $language); //FULL PATHS
Router::connect('/admin/:language/:controller', array('action' => 'index', 'admin' => true), $language); //CONTROLLER INDEXES
?>
